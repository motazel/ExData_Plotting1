...
# plot1: histogram of Global_active_power which is V3
GlobalActivePower = as.numeric(exdata_data_household_power_consumption[,3])
hist(GlobalActivePower, breaks=12, col = "red",main="Global Active Power", xlab="Global Active Power (kilowatts)", ylab = "Frequency")
